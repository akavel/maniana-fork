...
public class PageTheme extends Thumbnail {
    ...
    public PageTheme(String name, int drawableId, PageBackgroundType backgroundType,
            int backgroundSolidColor, ItemFontType fontType, PageItemFontSize fontSize,
